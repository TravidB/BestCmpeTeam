...
const HOTEL_INVENTORY = {
  ...
  'San Francisco, USA': [
    { name: 'The Marker San Francisco', stars: 4, baseRate: 320, amenities: ['Free WiFi','Gym','Restaurant','Bar','Concierge'], rating: '4.5', reviews: 2100, roomType: 'Deluxe Room', imageIndex: 0 },
    { name: 'Hotel Zephyr', stars: 4, baseRate: 280, amenities: ['Free WiFi','Bar','Restaurant','Outdoor Space'], rating: '4.3', reviews: 3100, roomType: 'Standard Room', imageIndex: 1 },
    { name: 'Fairmont San Francisco', stars: 5, baseRate: 580, amenities: ['Free WiFi','Spa','Restaurant','Bar','Concierge','Room Service'], rating: '4.7', reviews: 1800, roomType: 'Junior Suite', imageIndex: 2 },
    { name: 'Hilton San Francisco Union Square', stars: 4, baseRate: 240, amenities: ['Free WiFi','Pool','Gym','Restaurant','Bar'], rating: '4.2', reviews: 4500, roomType: 'Standard Room', imageIndex: 3 },
    { name: 'Westin St. Francis', stars: 5, baseRate: 460, amenities: ['Free WiFi','Spa','Restaurant','Bar','Concierge'], rating: '4.6', reviews: 2300, roomType: 'Deluxe Room', imageIndex: 4 },
  ],
}
...
export const hotelService = {
  async search(params) {
    const { destination, fromDate, toDate, adults = 1, children = 0, travelingWithPets = false, petCount = 1 } = params
    let hotels
